...
w = np.where((tab['sample']!='CSPI') | (tab['caltype']=='c')) # sample selection
...
f1 =open('../results/'+file[:-4]+'_result_CSPII.txt','w')
...
figure.savefig("../plots/mcmcH0_CSPI"+file[:-4]+"_"+str(nwalkers)+"_"+str(ssize)+".pdf")
