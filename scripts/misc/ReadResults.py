...
for i in range(len(filter)):
    ...
    #result = ascii.read('../../results/trippmethod/'+filter[i]+'_'+cal+'_resulttripp.txt')
    result = ascii.read('../../results/trippmethod/'+filter[i]+'_'+cal+'_update3_result_trippalpha.txt')
