...
pl.ylabel(r'$Color \ (B-V)$ [mag]',fontsize=14)
...
pl.subplot(1,2,1)
pl.errorbar(tab1['zhel'][w1],tab1['BV'][w1],yerr=tab1['eBV'][w1],fmt='ro',ms=12,label='$CSPI$')
pl.errorbar(tab1['zhel'][w2],tab1['BV'][w2],yerr=tab1['eBV'][w2],fmt='bo',ms=12,label='$CSPII$')
pl.xlabel(r'$z_{CMB}$',fontsize=18),pl.ylabel(r'$Color \ (B-V)$ [mag]',fontsize=18)
pl.legend(numpoints=1,loc='upper right',fontsize=16)
pl.grid()
pl.xticks(fontsize=16),pl.yticks(fontsize=16)

pl.subplot(1,2,2)
pl.errorbar(tab1['zhel'][w1],tab1['st'][w1],yerr=tab1['est'][w1],fmt='ro',ms=12,label='$CSPI$')
pl.errorbar(tab1['zhel'][w2],tab1['st'][w2],yerr=tab1['est'][w2],fmt='bo',ms=12,label='$CSPII$')
...
pl.xlabel(r'$Log \ host \ M_{stellar} \ (M_{\odot})$',fontsize=18)
pl.ylabel(r'$B-V \ (mag)$ [mag]',fontsize=18)
