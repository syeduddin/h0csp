...
pl.subplot(1,2,2)
pl.hist(tab1['m'][w1],bins=10,range=[7,12],histtype='stepfilled',label='Cepheid',color='b',lw=2, alpha=.3)
pl.hist(tab2['m'][w2],bins=10,range=[7,12],histtype='stepfilled',label='TRGB',color='r',lw=2, alpha=.3)
pl.hist(tab3['m'][w3],bins=10,range=[7,12],histtype='stepfilled',label='SBF',color='#377eb8',lw=2, alpha=.3)
