...
import sys
tab = ascii.read('../data/CSPI+II_max/B_max.csv')
...
s1 = np.where(tab1['sample']=='CSPI')
s2 = np.where(tab1['sample']=='CSPII')
...
pl.hist(tab1['zcmb'],range=[0,.14],bins=20,histtype='stepfilled',label='CSP',color='k', alpha=.3)
